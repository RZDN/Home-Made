...
public class IngredientController {
    ...
    @Operation(summary = "Get ingredients", description = "Get All Ingredients", tags = {"Ingredient Controller"})
    ...
    @Operation(summary = "Create Ingredients", description = "Create a new ingredients", tags = {"Ingredient Controller"})
    ...
    @Operation(summary = "Update ingredients", description = "Update ingredients for given Id", tags = {"Ingredient Controller"})
    ...
    @Operation(summary = "Delete ingredients", description = "Delete ingredients with given Id", tags = {"Ingredient Controller"})
