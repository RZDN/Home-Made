...
public class UserChefController {
    ...
    @Operation(summary = "Create UserChef", description = "Create a new UserChef", tags = {"User - Chef Controller"})
    ...
    @Operation(summary = "Update UserChef", description = "Update UserChef for given Id", tags = {"User - Chef Controller"})
    ...
    @Operation(summary = "Delete UserChef", description = "Delete UserChef with given Id", tags = {"User - Chef Controller"})
