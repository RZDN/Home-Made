...
public class MenuController {
    ...
    @Operation(summary = "Get menus", description = "Get All Menus", tags = {"Menu Controller"})
    @GetMapping("/menus")
    ...
    @Operation(summary = "Create Menus", description = "Create a new menus", tags = {"Menu Controller"})
    ...
    @Operation(summary = "Update menus", description = "Update menus for given Id", tags = {"Menu Controller"})
    ...
    @Operation(summary = "Delete menus", description = "Delete menus with given Id", tags = {"Menu Controller"})
