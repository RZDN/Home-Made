...
public class StepController {
    ...
    @Operation(summary = "Get Steps", description = "Get All Steps by RecipesId", tags = {"Step Controller"})
    ...
    @Operation(summary = "Create Step", description = "Create a new Step", tags = {"Step Controller"})
    ...
    @Operation(summary = "Update Step", description = "Update Step for given Id", tags = {"Step Controller"})
    ...
    @Operation(summary = "Delete Step", description = "Delete Step with given Id", tags = {"Step Controller"})
